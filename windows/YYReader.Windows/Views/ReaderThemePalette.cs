...
{
    public static ReaderThemePalette FromName(string name, ElementTheme systemTheme = ElementTheme.Light) => name switch
    {
        ...
        "mist" => Create(ElementTheme.Light, 0xE9, 0xF0, 0xF2, 0x2D, 0x39, 0x3D, 0x4C, 0x78, 0x86),
        "sage" => Create(ElementTheme.Light, 0xEA, 0xEF, 0xE7, 0x30, 0x39, 0x2E, 0x5D, 0x79, 0x55),
        ...
        _ when systemTheme == ElementTheme.Dark => Create(ElementTheme.Default, 0x20, 0x21, 0x24, 0xE4, 0xE6, 0xEA, 0x73, 0xA8, 0xD8),
        _ => Create(ElementTheme.Default, 0xF9, 0xFA, 0xFB, 0x25, 0x25, 0x27, 0x4E, 0x78, 0xA8)
    };
